...
namespace League_of_Legends_Counterpicks
{
    ...
    public sealed partial class ItemPage : Page
    {
        ...
        private async void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            var item = await SampleDataSource.GetItemAsync(id);
            this.DefaultViewModel["Item"] = item;
            this.DefaultViewModel["Role"] = SampleDataSource.GetGroupId(item.UniqueId);
            ...
            StackList.Add(Stack1);StackList.Add(Stack2);StackList.Add(Stack3);StackList.Add(Stack4);StackList.Add(Stack5);StackList.Add(Stack6);
